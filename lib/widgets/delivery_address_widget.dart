...
import 'package:vendor_app/model/address.dart';
import 'package:vendor_app/widgets/add_delivery_address.dart';
...
class _DeliveryAddressWidgetState extends State<DeliveryAddressWidget> {
  ...
  Future<void> _getUserDetails() async {
    ...
    User? user = auth.currentUser;
    setState(() {
      firestore.collection('vendors').doc(user!.uid).snapshots().listen((value) {
        setState(() {
