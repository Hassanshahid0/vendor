...
class AddFlashSales extends ConsumerStatefulWidget {
  const AddFlashSales({
    super.key,
  });

  @override
  ConsumerState<AddFlashSales> createState() => _AddFlashSalesState();
}

class _AddFlashSalesState extends ConsumerState<AddFlashSales> {
          ...
          child: Padding(
            ...
            child: Form(
              ...
              child: Column(children: [
                ...
                const SizedBox(height: 20),
                const Text('Add a new Flash sales',
