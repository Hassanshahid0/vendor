...
class AddDeals extends ConsumerStatefulWidget {
  const AddDeals({
    super.key,
  });

  @override
  ConsumerState<AddDeals> createState() => _AddDealsState();
}

class _AddDealsState extends ConsumerState<AddDeals> {
            ...
            child: Form(
              ...
              child: Column(children: [
                ...
                ref.watch(productFormProviderProvider).imageFile1 == null
                    ...
                    : Image.file(
                        File(ref.watch(productFormProviderProvider).imageFile1!),
                        width: 120,
                        height: 120),
                Padding(
                  padding: const EdgeInsets.all(8.0),
